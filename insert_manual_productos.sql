-- Insertar manual de usuario para creación de productos
-- Usando categoría ID 2 (User Manual)
...
INSERT INTO appcore_manualentry (
    ...
    'Manual de Usuario: Creación de Productos con Precios',
    'manual-usuario-creacion-productos-precios',
    'Inventario',
    'Guía completa paso a paso para crear productos, configurar precios y realizar transacciones en el sistema ChalanPro. Incluye ejemplos prácticos, solución de problemas comunes y mejores prácticas.',
    '# 📦 Manual de Usuario: Creación de Productos con Precios
